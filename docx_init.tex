...
\caption{Maps of sediment thickness and Moho depth across the study region in Patagonia.
}
\label{fig1}
\end{figure}
...
type 2 & 2 \\ \hline 
\end{tabular}
\caption{A table containing some minimally useful information about dogs and spiders.
}
\label{tbl1}
\end{table}
